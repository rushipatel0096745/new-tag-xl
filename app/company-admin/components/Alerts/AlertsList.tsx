...
const AlertsList = () => {
    ...
    useEffect(() => {
        ...
        async function fetchRoles() {
            ...
            const response = await GetAlertsList(page, pageSize, parsedFilters);
        ...
        window.addEventListener("AlertFiltersChanged", handleFiltersChanged);
