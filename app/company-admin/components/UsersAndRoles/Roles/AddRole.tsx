...
const AddRole = () => {
    ...
    async function getPermissionList() {
        try {
            const result = await clientFetch("/company/permission-list", {
                method: "GET",
                headers: {
    ...
    async function createRole(data: any): Promise<void> {
        try {
            const result = await clientFetch("/company/role/create", {
                method: "POST",
                headers: {
                    "X-Session-ID": sessionId,
                    "X-Company-ID": companyId,
            ...
            setShowMsg("Role Created succesfully");
            ...
            <form className='flex flex-col gap-6'>
                <div className='grid grid-cols-2 gap-4'>
                    ...
                    <div className=''>
                        ...
                        <input type='text' className='form-input' onChange={(e) => setRoleName(e.target.value)} />
                    </div>
                </div>
