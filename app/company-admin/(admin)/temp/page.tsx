        ...
        data: [
            {
                ...
                firstname: "Alice",
                lastname: "Smith",
                email: "alice@corewix.com",
                last_logged_in: "2024-03-10T10:00:00",
                role_id: 1,
            },
            {
                id: 5,
                firstname: "Bob",
                lastname: "Jones",
                email: "bob@corewix.com",
                last_logged_in: "2024-03-12T14:30:00",
                role_id: 2,
            },
            {
                id: 6,
                firstname: "Carol",
                lastname: "White",
                email: "carol@corewix.com",
                last_logged_in: "2024-02-28T09:15:00",
                role_id: 1,
            },
        ],
        total: 3,
                ...
                <div style={styles.section}>
                    <div style={styles.sectionHeader}>
                        <div style={styles.sectionTitle}>
                            Filters
                            {activeFiltersCount > 0 && <span style={styles.badge}>{activeFiltersCount} active</span>}
                        </div>
