...
import { GetSuperUserPermissions } from "@/app/services/super-admin/role";
import { createRole } from "@/app/services/super-admin/role-action";
...
const AddRole = () => {
    ...
    const [state, formAction, isPending] = useActionState(createRole, {
        success: null,
        error: "",
        data: null,
    });
